...
$(document).ready(function () {
    ...
    nCloneTd.innerHTML = '<img class="pure" src="/OuterTools/assets/advanced-datatable/examples/examples_support/details_open.png">';
     ...
     */
    $('#hidden-table-info tbody td .pure').live('click', function () {
